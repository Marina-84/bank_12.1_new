...
"""
        ...
        if menu_item == "1":
            ...
            transactions = get_transactions_list(PATH_TO_FILE_JSON)
            break
        elif menu_item == "2":
            print("Для обработки выбран CSV-файл.")
            transactions = read_csv_transactions(PATH_TO_FILE_CSV)
            break
        elif menu_item == "3":
            print("Для обработки выбран XLSX-файл.")
            transactions = read_xlsx_transactions(PATH_TO_FILE_EXCEL)
            break
        else:
